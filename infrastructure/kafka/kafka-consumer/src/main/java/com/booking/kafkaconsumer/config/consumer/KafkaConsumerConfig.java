package com.booking.kafkaconsumer.config.consumer;

import com.booking.kafkaconsumer.config.KafkaConsumerBasicConfigData;
...
public class KafkaConsumerConfig<K, V> {
    private final KafkaConsumerBasicConfigData kafkaConsumerBasicConfigData;
    private final KafkaConsumerConfigData kafkaConsumerConfigData;

    @Bean
    public Map<String, Object> consumerConfigs() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaConsumerBasicConfigData.getBootstrapServers());
        ...
        props.put(kafkaConsumerBasicConfigData.getSchemaRegistryUrlKey(), kafkaConsumerBasicConfigData.getSchemaRegistryUrl());
